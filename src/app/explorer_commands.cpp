...
constexpr std::array kBaseCommands = {
    ...
    CommandSpec{.command = ExplorerCommand::ToggleGitIgnored,
                ...
                .repeatable = false,
                .visualModePolicy = VisualModePolicy::Preserve},
    CommandSpec{.command = ExplorerCommand::PreviewScrollDown,
                .name = "preview_scroll_down",
                .description = "Scroll preview down",
                .category = "View",
                .repeatable = true,
                .visualModePolicy = VisualModePolicy::Preserve},
    CommandSpec{.command = ExplorerCommand::PreviewScrollUp,
                .name = "preview_scroll_up",
...
constexpr std::array kBaseBindings = {
    ...
    BindingSpec{.keys = "M-j",
                .command = ExplorerCommand::PreviewScrollDown,
                .mode = ui::Mode::Normal,
                .description = "Scroll preview down"},
    BindingSpec{.keys = "M-k",
                .command = ExplorerCommand::PreviewScrollUp,
                .mode = ui::Mode::Normal,
                .description = "Scroll preview up"},
    BindingSpec{
